...
echo "== Org1 Minter minting some NTFs =="
for n in $(seq 1 5)
do
  peer chaincode invoke $TARGET_TLS_OPTIONS -C mychannel -n token_erc721 -c '{"function":"MintWithTokenURI","Args":["'"001/001/00${n}"'", "'"https://landregistry.acme.com/parcel-nft-001-001-00${n}.json"'"]}'
done
echo ""
sleep 3

echo "== Org1 Minter Identity and Balance =="
